export default {
  account: {
    avatar: 'Você pode criar ou atualizar seu avatar em gravatar.com',
  ...
  article: {
    ...
    locked: 'Premium',
    lockedDescription:
      'Esta publicação está protegida por acesso pago ou assinatura',
    ...
    share: {
      ...
      pinterest: 'Compartilhar no Pinterest',
  ...
  contribute: {
    ...
    description:
      'Você pode usar este formulário para enviar uma notícia, sugerir um produto para avaliação ou compartilhar uma dica do diretório.',
    errors: {
      category: {
      ...
      description: {
        ...
        min: 'A descrição precisa ter pelo menos 20 caracteres.',
      },
      email: {
    ...
    help: {
      description:
        'Forneça uma breve descrição do que você gostaria de contribuir, juntamente com um link, se aplicável.',
      email:
        'Usaremos isso apenas para entrar em contato com você sobre sua contribuição.',
    },
    labels: {
      category: 'Categoria',
    ...
    sent: 'Sua contribuição foi enviada. Iremos analisá-lo e entraremos em contato em breve no endereço de e-mail fornecido.',
    title: 'Contribuir',
    toast: {
      error: {
      ...
      success: {
        title: 'Submetido!',
        message: 'Recebemos seu envio e o analisaremos em breve.',
      },
    },
  },
  covidnet: {
  ...
  directory: {
    instructions:
      'Selecione uma categoria ou país para começar a pesquisar no diretório',
  ...
  home: {
    description:
      'That Covid Life - Uma plataforma para conselhos sobre a Covid',
    pageTitle: 'Ùltimas Publicações',
    title: 'That Covid Life - Ùltimas Publicações',
    events: 'Próximos eventos',
    eventsDescription:
      'Um fluxo menor de conversas, webinars e encontros que vale a pena manter no radar.',
    eventsEyebrow: 'Próximos eventos',
    guidedQuestion3:
      'O que devo fazer se as pessoas ao meu redor estiverem doentes?',
    guidedQuestionsDescription:
      'Abra o chatbot com uma pergunta inicial e continue até a resposta realmente ajudar.',
    guidedQuestionsDescriptionSignedOut:
      'Faça login com uma conta gratuita para abrir o chatbot e manter um registro do que você está tentando entender.',
    guidedQuestionsEyebrow: 'Orientação prática',
    guidedQuestionsTitle:
      'Comece pela pergunta que você realmente quer responder.',
    guidanceCopy:
      'Use o chatbot para testar decisões do dia a dia e encontrar fontes que valem a leitura.',
    guidanceLabel: 'Orientação prática',
    heroDescription:
      'Reportagem curada, contexto científico e orientação prática para entender o risco da COVID sem ruído nem falso conforto.',
    heroEyebrow: 'Risco de COVID, explicado com clareza',
    heroPrimaryCta: 'Ler o que importa agora',
    heroSecondaryCta: 'Fazer uma pergunta prática',
    heroSecondaryCtaSignedOut: 'Entrar para fazer uma pergunta',
    heroTitle:
      'Entenda o que importa agora. Faça a pergunta que você realmente tem.',
    latestNews: 'Últimas notícias',
    library: 'Biblioteca científica',
    nowDescription:
      'Uma leitura rápida das histórias, estudos e mudanças de saúde pública que merecem sua atenção primeiro.',
    nowEyebrow: 'Panorama editorial',
    nowTitle: 'O que importa agora',
    phw: 'De olho na sáude pública',
    reportingDescription:
      'Estas são as histórias mais claras para entender o que está mudando agora no seu quadro de risco.',
    reportingEyebrow: 'Cobertura',
    reportingTitle:
      'Comece pela cobertura que muda a forma como você lê o risco.',
    researchCopy:
      'Saia das manchetes e vá para os estudos quando precisar de evidência, não apenas de resumo.',
    researchDescription:
      'Vá da cobertura atual para os artigos, revisões e evidências que dão peso às notícias.',
    researchEyebrow: 'Contexto científico',
    researchLabel: 'Contexto científico',
    researchTitle:
      'Aprofunde-se quando precisar dos estudos por trás das afirmações.',
    ...
    signalCopy:
      'Comece pelas reportagens e mudanças de saúde pública com maior chance de afetar a sua semana.',
    signalCta: 'Abrir a editoria de notícias',
    signalEyebrow: 'O sinal de hoje',
    signalLabel: 'O que importa agora',
    signalTitle:
      'Três pontos de partida quando você precisa do quadro mais claro.',
    videos: 'Vídeos',
    watchAndAttendDescription:
      'Acompanhe por meio de explicações, entrevistas e eventos que conectam a ciência às decisões do cotidiano.',
    watchAndAttendEyebrow: 'Assistir e participar',
    watchAndAttendTitle:
      'Use vídeos e eventos ao vivo quando a leitura não for suficiente.',
    watchDescription:
      'Use este caminho quando quiser enxergar além de um único ciclo de manchetes, incluindo sinais mais amplos de saúde pública e ameaças emergentes.',
    watchEyebrow: 'Saúde pública',
    watchTitle: 'Mantenha o quadro geral no seu campo de visão.',
  },
  layout: {
    about: 'Sobre',
    blog: 'Blog',
    ...
    education: 'Educação',
    empty: {
      blog: 'Ainda não há postagens no blog.',
      community: 'Ainda não há links de comunidade.',
      directory: 'Nenhuma listagem de diretório ainda.',
  ...
  list: {
    ...
    filters: {
      ...
      selectContentType: 'Selecione um tipo de conteúdo...',
  ...
  reviews: {
    ...
    list: {
      description:
        'Você está visualizando avaliações de {start} a {end} de {total}.',
    },
    notLoggedIn: 'Você deve estar logado para postar uma avaliação do produto.',
    noReviews: 'Ainda não há comentários para este produto.',
    placeholder: 'Digite seu comentário aqui...',
    rate: 'Avalie Este Produto',
    signIn: 'Entrar agora',
    submit: 'Envie sua avaliação',
    title: 'Comentários',
    toast: {
      error: {
        message: 'Não podemos publicar sua avaliação no momento.',
        title: 'Algo deu errado',
      },
      success: {
        message: 'Sua avaliação foi publicada.',
        title: 'Revisão adicionada!',
      },
      update: {
    ...
    update: 'Atualize seu comentário',
  },
  search: {
    description:
      'That Covid Life - Uma plataforma para conselhos sobre a Covid',
    pageTitle: '{totalItems} Resultado(s) da busca por "{searchTerm}"',
  ...
  forum: {
    account: {
      ...
      signIn: 'Faça Login Para Postar',
    },
    auth: {
      description:
        'Digite seu endereço de e-mail para receber um link de login',
    ...
    comments: {
      ...
      deletion: {
        ...
        description:
          'Você está prestes a excluir seu comentário. Isto não pode ser desfeito.',
      },
      description:
        'Você está visualizando o(s) comentário(s) {start} até {end} de {total}.',
    ...
    create: {
      ...
      modal: {
        ...
        description:
          'Você está prestes a publicar este post. Não pode ser editado posteriormente.',
        confirmation:
    ...
    disabled: {
      message: {
        comment:
          'Você precisa configurar um nome de usuário antes de poder comentar.',
    ...
    list: {
      description:
        'Você está visualizando post(s) {start} até {end} de {total}.',
    },
    post: {
    ...
    posts: {
      ...
      modal: {
        ...
        description:
          'Você está prestes a deletar {amount} post(s). Isto não pode ser desfeito.',
  ...
  mobile: {
    ...
    details: {
      archive: {
        ...
        description:
          'Você pode acessar toda a nossa coleção de notícias, artigos científicos, recursos, vídeos, EPI e eventos futuros em todos os idiomas suportados.',
      },
      contribute: {
        title: 'Contribua para nossa plataforma',
        description:
          'Você pode nos enviar links, dicas de EPI e até mesmo algum conteúdo original por meio de nosso formulário de contribuição.',
      },
      informed: {
        title: 'Mantenha-se informado em qualquer lugar',
        description:
          'Com nosso aplicativo, você pode se manter informado sobre as últimas atualizações e achados científicos sobre a pandemia de COVID-19.',
      },
    },
  ...
  topNav: {
    ...
    latest: {
      children: {
        events: {
          description: 'Eventos futuros e passados ​​sobre a COVID-19.',
          title: 'Eventos',
        },
        library: {
          description:
            'As últimas pesquisas e artigos científicos sobre a COVID-19.',
          title: 'Biblioteca científica',
        },
        news: {
          description: 'As últimas notícias sobre a COVID-19.',
          title: 'Notícias',
        },
        phw: {
          description:
    ...
    other: {
      children: {
        covidnet: {
          description:
            'Uma lista selecionada de blogs e canais do YouTube sobre a COVID-19.',
          title: 'Covidnet',
        },
        directory: {
          description:
        ...
        products: {
          description:
            'Uma lista de equipamentos de proteção individual, como máscaras, purificadores de ar, etc...',
          title: 'EPI',
        },
        resources: {
          description: 'Uma lista de recursos úteis sobre a COVID-19.',
          title: 'Recursos',
        },
      },
      title: 'Ferramentas',
  ...
  description: {
    ...
    forum:
      'Um fórum de usuários para trocar dicas, experiências e depoimentos.',
    covidnet:
      'Uma lista selecionada de blogs e canais do YouTube sobre a COVID-19.',
    directory:
      'Um diretório de empresas e provedores de saúde preocupados com a COVID.',
    event: 'Eventos futuros e passados ​​sobre a COVID-19.',
    'scientific-library':
      'As últimas pesquisas e artigos científicos sobre a COVID-19.',
    news: 'As últimas notícias sobre a COVID-19.',
    product:
      'Uma lista de equipamentos de proteção individual, como máscaras, purificadores de ar, etc...',
    'public-health':
      'As últimas notícias sobre pandemias emergentes, como Mpox e H5N1.',
  ...
  filters: {
    ...
    placeholder: {
      ...
      isEventFree: 'Selecionar tipo de evento...',
      language: 'Selecionar idioma...',
      onlineOnly: 'Selecionar apenas online...',
      source: 'Selecionar fonte...',
      tag: 'Selecionar tag...',
      type: 'Selecionar tipo de conteúdo...',
    },
    reset: 'Redefinir filtros',
    title: 'Filtros',
  },
  ...
  searchbox: {
    clear: 'Limpar busca',
    placeholder: 'Pesquisar notícias, estudos, saúde pública e vídeos...',
    results: {
      error: 'Não foi possível pesquisar agora.',
      hint: 'Tente uma palavra-chave mais ampla ou abra a busca completa para explorar melhor.',
      loading: 'Pesquisando...',
  ...
  chatbot: {
    ...
    share: {
      ...
      never: 'Nunca',
      days: 'dias',
      customSlug: 'Slug personalizado (opcional)',
      create: 'Criar Compartilhamento',
      existingLinks: 'Links de Compartilhamento Existentes',
      revoke: 'Revogar',
      revokeConfirm:
        'Tem certeza de que deseja revogar este link de compartilhamento?',
      toasts: {
      ...
      publicPage: {
        ...
        expired: 'Este link de compartilhamento expirou',
        notFound: 'Chat compartilhado não encontrado',
