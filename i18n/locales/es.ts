export default {
  ...
  article: {
    alternateLink: '¿Tienes problemas para acceder al material? Intenta aquí.',
    call: 'Llamar',
  ...
  home: {
    ...
    signalTitle: 'Tres puntos de partida cuando necesitas la visión más clara.',
    videos: 'Videos',
  },
  layout: {
    ...
    donateBanner: {
      ariaLabel: 'Banner de apoyo con donaciones',
      cta: 'Donar',
      dismiss: 'Cerrar banner de donaciones',
      message:
        'Ayuda a mantener That Covid Life en marcha. Apoya las herramientas y reportajes sin anuncios en los que la gente confía.',
    },
  ...
  description: {
    ...
    tag: 'Navega por nuestros archivos por etiqueta.',
  ...
  filters: {
    ...
    placeholder: {
      ...
      isEventFree: 'Selecciona tipo de evento...',
      language: 'Selecciona un idioma...',
      onlineOnly: 'Selecciona solo en línea...',
      source: 'Selecciona una fuente...',
      tag: 'Seleccionar etiqueta...',
      type: 'Seleccionar tipo de contenido...',
    },
    reset: 'Restablecer filtros',
    title: 'Filtros',
  },
  ...
  chatbot: {
    actions: {
      ...
      toasts: {
        ...
        pdfExport: 'Tu PDF se está descargando',
    ...
    share: {
      ...
      publicPage: {
        ...
        notFound: 'Chat compartido no encontrado',
        tryYourself: 'Prueba este chat tú mismo',
